...
function nextMusic() {
    ...
    // if musicIndex is greater than array length than musicIndex will be 1 so the first music play
...
// prev music function 
function prevMusic() {
    musicIndex--; // decresment of musicIndex by 1
    // if musicIndex is less than array length than musicIndex will be 1 so the first music play
...
progressArea.addEventListener("click", (e) => {
    ...
    let songDuration = mainAudio.duration; // getting sond total duration
...
mainAudio.addEventListener("ended", () => {
    ...
    switch (getText) {
        ...
        case "repeat_one":
            ...
            loadMusic(musicIndex); // calling load music functionwith argument, in the argument there is a index of current song
...
for (let i = 0; i < allMusic.length; i++) {
    ...
    <span id="${allMusic[i].src}" class="audio-duration">02:45</span>
</li>`;
...
function playingSong(){
    for(let j = 0; j < allLiTags.length; j++){
        ...
        // adding on click attrubute in all li tags
